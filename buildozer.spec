...
source.include_exts = py,png,jpg,kv,atlas,ini,po,mo,rst,txt,wav,arr
...
requirements =  python3crystax==3.6, pyjnius, plyer, android, kivy==master, git+https://gitlab.com/kivymd/KivyMD.git
