...
requirements =  python3crystax==3.6, pyjnius, jnius, plyer, git+https://github.com/kivy/python-for-android.git, kivy==master, git+https://gitlab.com/kivymd/KivyMD.git
...
# bootstrap)
android.add_aars = support-v4-24.0.0.aar
