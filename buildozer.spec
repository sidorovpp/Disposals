...
source.include_exts = py,png,jpg,kv,atlas,ini,po,mo,rst,txt,wav
...
requirements =  python3crystax==3.6, pyjnius, plyer, android, android.permissions, kivy==master, git+https://gitlab.com/kivymd/KivyMD.git
