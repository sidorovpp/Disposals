...
requirements = hostpython3==3.10,python3==3.10,kivy==2.0.0rc4,https://github.com/kivymd/KivyMD/archive/master.zip,pygments,sdl2_ttf==2.0.15,pillow, pyjnius, jnius, git+https://github.com/kivy/plyer@master#egg=plyer
